...
class DatePickerModel extends CommonPickerModel {
  ...
  DatePickerModel(
      ...
      LocaleType? locale})
      : super(locale: locale) {
    this.maxTime = maxTime ?? DubaiDateTime.custom(2049, 12, 31).dateTime;
    this.minTime = minTime ?? DubaiDateTime.custom(1970, 1, 1).dateTime;

    currentTime = currentTime ?? DubaiDateTime.now().dateTime;
...
class TimePickerModel extends CommonPickerModel {
  ...
  TimePickerModel(
      ...
      : super(locale: locale) {
    this.currentTime = currentTime ?? DubaiDateTime.now().dateTime;
...
class Time12hPickerModel extends CommonPickerModel {
  ...
  DateTime finalTime() {
    ...
    return currentTime.isUtc
        ...
        : DubaiDateTime.custom(currentTime.year, currentTime.month,
                currentTime.day, hour, _currentMiddleIndex, 0)
            .dateTime;
  }
}
...
class DateTimePickerModel extends CommonPickerModel {
  ...
  DateTimePickerModel(
    ...
    if (currentTime != null) {
      ...
      this.maxTime = maxTime;
      this.minTime = minTime;
      var now = DubaiDateTime.now().dateTime;
  ...
  DateTime finalTime() {
    ...
    return currentTime.isUtc
        ...
        : DubaiDateTime.custom(time.year, time.month, time.day, hour, minute)
            .dateTime;
  }
